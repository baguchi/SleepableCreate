...
public class AnchorInteractionBehaviour extends MovingInteractionBehaviour {


    public boolean handlePlayerInteraction(Player player, InteractionHand activeHand, BlockPos localPos,
                                           AbstractContraptionEntity contraptionEntity) {
        if (player instanceof IHasStaticRespawn sleep && contraptionEntity.level.dimensionType().respawnAnchorWorks()) {
